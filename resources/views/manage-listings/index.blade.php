                        ...
                        <tr class="border-gray-300">
                            ...
                            >
                                ...
                                <p class="border px-4 py-2 text-center">
                                    <i
                                        class="fa-solid fa-heart text-rose-900"
                                    ></i>
                                    {{-- Count Favorites --}}
                                    @php
                                        $i = 0;
                                ...
                                <x-card>
                                    ...
                                    @if ($artwork->original)
                                        <div class="text-indigo-900 text-sm">
                                            <i
                                                class="text-green-900 fa-solid fa-check inline"
                                            ></i>
                                            <p
                                                class="inline text-indigo-900 font-bold text-sm"
                                            >
                                                Original: Available
                                            </p>
                                            <h1>
                                    ...
                                    @else
                                        <div class="text-indigo-900 text-sm">
                                            <i
                                                class="text-rose-900 fa-solid fa-times inline"
                                            ></i>
                                            <p
                                                class="inline text-indigo-900 font-bold"
                                            >
                            ...
                            >
                                ...
                                >
                                    <i
                                        class="fa-solid fa-pen-to-square text-green-900"
                                    ></i>
                                    Edit
                                </a>
                            </td>
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        <i
                                            class="text-rose-900 fa-solid fa-archive inline"
                                        ></i>
                                        <p
                                            class="text-md text-stone-600 inline"
                                        >
                                            Archive
                                        </p>
                                    </button>
