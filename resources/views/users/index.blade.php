                            ...
                            <td class="border-t border-b border-gray-300">
                                <x-card>
                                    <div>
                                        ...
                                        <p
                                            class="text-sm text-indigo-900 font-bold"
                                        >
                                            {{ $user->firstname }}
                                            {{ $user->lastname }}: ID#
                                            {{ $user->id }}
                                        ...
                                        <div
                                            class="text-indigo-500 font-bold text-sm"
                                        >
                                            {{-- Email Address --}}
                                            <div>
                                                <a
                                            ...
                                            @if ($user->subscribe == 1)
                                                <i
                                                    class="fas fa-check text-indigo-500"
                                                ></i>
                                                <span
                                                    class="inline text-indigo-900"
                                                >
                                                    Yes
                                                </span>
                                            @else
                                                <i
                                                    class="fas fa-times text-rose-500"
                                                ></i>
                                                <span
                                                    class="inline text-indigo-900"
                                                >
